...
public interface WebtoonService { //인터페이스와 class를 찢어놓는것이 루즈커플링이라는 것이다 >> 결합되는 Controller, Service, Class 각 객체들 간의 의존성을 줄여주는 것
    ...
    WebtoonDto saveWebtoon(String id, String webtoonId, String webtoonName, String webtoonAuthor, String webtoonGenre, String webtoonSummary, String webtoonURL, String webtoonThumbnail, String webtoonKeyword, String platform);
